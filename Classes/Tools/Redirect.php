 ...
 */
class Redirect implements \TYPO3\CMS\Core\SingletonInterface
{
     ...
     * @return string
     */
    static public function urlToPageUid($pageUid, $createAbsoluteUri = true, $linkAccessRestrictedPages = true, $useCacheHash = false)
    {
     ...
     */
    static public function checkRedirectUrl($url)
    {

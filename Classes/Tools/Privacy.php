 ...
 */
class Privacy implements \TYPO3\CMS\Core\SingletonInterface
{
     ...
     * 2. After successful optIn zhe 5th param is used to create the relationship between the two created privacy-datasets
     *
     ...
     * RKW\\RkwRegistration\\Tools\\Registration->register You have just to use ->setPrivacyDataBeforeOptIn and

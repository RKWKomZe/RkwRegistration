    ...
    public function getRedirectUrlLogin()
    {
        ...
        ($feAuth = $GLOBALS['TSFE']->fe_user)
            ...
            if (
                ...
                $params[] = 'tx_rkwregistration_authexternal[xdlToken]=' . $authentication->setCrossDomainLoginToken($baseUrl);
                ...
                if (
                    ...
                    $params[] = 'tx_rkwregistration_authexternal[xdlRedirect]=' . urlencode($checkedRedirectUrl);
                    ...
                    if ($settings['users']['welcomePid']) {
                        ...
                        $params[] = 'tx_rkwregistration_authexternal[xdlRedirect]=' .
                            urlencode(
                                $uriBuilder->reset()
                    ...
                    $params[] = 'tx_rkwregistration_authexternal[xdlRedirect]=' .
                        urlencode(
                            $uriBuilder->reset()
                                ...
                                ->setArguments(
                                    array(
                                        'tx_rkwregistration_authexternal' => array(
                                            'logoutMessage' => 1,
                                        ),
                                    )
                                )

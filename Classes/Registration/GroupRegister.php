 ...
 */
class GroupRegister //extends AbstractRegistration
{
    /**
    ...
    public function getMandatoryFields(): array
    {
        ...
        if ($this->settings['users']['requiredFormFields']) {
            $requiredFields = explode(
                ',',
                str_replace(' ', '', $this->settings['users']['requiredFormFields']))
            ;
        }
        ...
        /** @var \RKW\RkwRegistration\Register\GroupFrontendUser $groupRegister */
        $groupRegister = $objectManager->get(GroupFrontendUser::class);
